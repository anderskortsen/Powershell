...
$Result=@()
$Users = Get-AzureADGroupMember -ObjectId "911cad46-0b62-4363-ae16-64f8353a46c5" | Select-Object UserPrincipalName,ObjectId
...
$Result | Select-Object DeviceOwner,DeviceName,DeviceOSType,DeviceOSVersion,ApproximateLastLogonTimeStamp
